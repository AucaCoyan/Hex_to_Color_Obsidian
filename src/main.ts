...
const DEFAULT_SETTINGS: HexToColorSettings = {
	mySetting: "default",
};

export default class HexToColor extends Plugin {
	...
	async onload() {
		...
		this.addSettingTab(new HexToColorSettingTab(this.app, this));
...
class HexToColorSettingTab extends PluginSettingTab {
	plugin: HexToColor;

	constructor(app: App, plugin: HexToColor) {
		super(app, plugin);
		this.plugin = plugin;
	}
